...
<img src="media/SpeedRun.gif" alt="SpeedRun" width=80%>

*Speed Run*

<img src="media/Exploration.gif" alt="Exploration" width=80%>

*Exploring an unknown map and return to the initial pose*

<img src="media/Relocalization.gif" alt="Relocalization" width=80%>
...
<img src="media/Software.png" alt="Software" width=60%>
...
<img src="media/FirmwareControl.png" alt="FirmwareControl" width=80%>
...
<img src="media/Velocity.png" alt="Velocity" width=60%>
...
<img src="media/SLAM.png" alt="SLAM" width=60%>

## Path Planning
Path planning implementation utilizes an A* search algorithm enhanced with obstacle distance constraints for safe and efficient trajectory generation.

<img src="media/AstarPlanning.png" alt="AstarPlanning" width=60%>