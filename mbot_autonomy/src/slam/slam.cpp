...
void OccupancyGridSLAM::runSLAMIteration(void)
{
    ...
    /* The code below would cause the odometry to jump massively and introduces errors in slam. 
     * However removing it might cause massive odometry drift if the odometry calculation was too bad.
     * Only uncomment it if you think it would be helpful for your situation. */ 
...
void OccupancyGridSLAM::initializePosesIfNeeded(void)
{
    ...
    {
        // XX: Relocate the robot to the initial pose, remember to uncomment the following code when doing relocalization
        // std::ifstream poseFile("/home/mbot/mbot_ws/mbot_autonomy/src/slam/current_pose.txt");
        // if (poseFile.is_open())
        // {
        //     poseFile >> initialPose_.x >> initialPose_.y >> initialPose_.theta;
        //     poseFile.close();
        // }
        // else
        // {
        //     std::cerr << "ERROR: Unable to open current_pose.txt file.\n";
        // }
