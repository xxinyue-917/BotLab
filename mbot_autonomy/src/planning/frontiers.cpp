...
bool is_frontier_cell(int x, int y, const OccupancyGrid& map)
{
    ...
    for(int n = 0; n < kNumNeighbors; ++n)
    {
        ...
        // if(map.logOdds(x + xDeltas[n], y + yDeltas[n]) < 0 || (map.logOdds(x + xDeltas[n], y + yDeltas[n]) < 10 && map.logOdds(x + xDeltas[n], y + yDeltas[n]) > 0))    // Change the threshold for a free cell here
